$(function () {
	...
	var dataMonthlyRevenueByCategory = {
		"Men Clothing": {
			...
			dataPoints: [
				{ x: new Date("1 Jan 2017"), y: 25987.50 },
				{ x: new Date("1 Feb 2017"), y: 23436.00 },
				{ x: new Date("1 Mar 2017"), y: 29988.00 },
				{ x: new Date("1 Apr 2017"), y: 20790.00 },
				{ x: new Date("1 May 2017"), y: 36288.00 },
				{ x: new Date("1 Jun 2017"), y: 30870.00 },
				{ x: new Date("1 Jul 2017"), y: 28728.00 },
				{ x: new Date("1 Aug 2017"), y: 30996.00 },
				{ x: new Date("1 Sep 2017"), y: 25200.00 },
				{ x: new Date("1 Oct 2017"), y: 21168.00 },
				{ x: new Date("1 Nov 2017"), y: 30996.00 },
				{ x: new Date("1 Dec 2017"), y: 37926.00 }
			]
		},
		"Women Clothing": {
			color: "#e5d8b0",
			...
			yValueFormatString: "$###,###.00",
			dataPoints: [
				{ x: new Date("1 Jan 2017"), y: 19057.50 },
				{ x: new Date("1 Feb 2017"), y: 15624.00 },
				{ x: new Date("1 Mar 2017"), y: 34272.00 },
				{ x: new Date("1 Apr 2017"), y: 24948.00 },
				{ x: new Date("1 May 2017"), y: 31752.00 },
				{ x: new Date("1 Jun 2017"), y: 26460.00 },
				{ x: new Date("1 Jul 2017"), y: 23940.00 },
				{ x: new Date("1 Aug 2017"), y: 36162.00 },
				{ x: new Date("1 Sep 2017"), y: 30240.00 },
				{ x: new Date("1 Oct 2017"), y: 26460.00 },
				{ x: new Date("1 Nov 2017"), y: 36162.00 },
				{ x: new Date("1 Dec 2017"), y: 43344.00 }
			]
		},
		"Gadgets": {
			color: "#ffb367",
			...
			yValueFormatString: "$###,###.00",
			dataPoints: [
				{ x: new Date("1 Jan 2017"), y: 41580.00 },
				{ x: new Date("1 Feb 2017"), y: 41013.00 },
				{ x: new Date("1 Mar 2017"), y: 42840.00 },
				{ x: new Date("1 Apr 2017"), y: 37422.00 },
				{ x: new Date("1 May 2017"), y: 36288.00 },
				{ x: new Date("1 Jun 2017"), y: 44100.00 },
				{ x: new Date("1 Jul 2017"), y: 38304.00 },
				{ x: new Date("1 Aug 2017"), y: 36162.00 },
				{ x: new Date("1 Sep 2017"), y: 50400.00 },
				{ x: new Date("1 Oct 2017"), y: 63504.00 },
				{ x: new Date("1 Nov 2017"), y: 56826.00 },
				{ x: new Date("1 Dec 2017"), y: 65016.00 }
			]
		},
		"Books": {
			color: "#f98461",
			...
			yValueFormatString: "$###,###.00",
			dataPoints: [
				{ x: new Date("1 Jan 2017"), y: 17325.00 },
				{ x: new Date("1 Feb 2017"), y: 27342.00 },
				{ x: new Date("1 Mar 2017"), y: 25704.00 },
				{ x: new Date("1 Apr 2017"), y: 16632.00 },
				{ x: new Date("1 May 2017"), y: 13608.00 },
				{ x: new Date("1 Jun 2017"), y: 17640.00 },
				{ x: new Date("1 Jul 2017"), y: 23940.00 },
				{ x: new Date("1 Aug 2017"), y: 15498.00 },
				{ x: new Date("1 Sep 2017"), y: 25200.00 },
				{ x: new Date("1 Oct 2017"), y: 21168.00 },
				{ x: new Date("1 Nov 2017"), y: 15498.00 },
				{ x: new Date("1 Dec 2017"), y: 10836.00 }
			]
		},
		"Others": {
			color: "#d9695f",
			...
			yValueFormatString: "$###,###.00",
			dataPoints: [
				{ x: new Date("1 Jan 2017"), y: 69300.00 },
				{ x: new Date("1 Feb 2017"), y: 87885.00 },
				{ x: new Date("1 Mar 2017"), y: 81396.00 },
				{ x: new Date("1 Apr 2017"), y: 108108.00 },
				{ x: new Date("1 May 2017"), y: 108864.00 },
				{ x: new Date("1 Jun 2017"), y: 101430.00 },
				{ x: new Date("1 Jul 2017"), y: 124488.00 },
				{ x: new Date("1 Aug 2017"), y: 139482.00 },
				{ x: new Date("1 Sep 2017"), y: 120960.00 },
				{ x: new Date("1 Oct 2017"), y: 132300.00 },
				{ x: new Date("1 Nov 2017"), y: 118818.00 },
				{ x: new Date("1 Dec 2017"), y: 113778.00 }
			]
		}
	};
		...
		"New Visitors": [
			{
				...
				type: "column",
				dataPoints: [
					{ x: new Date("1 Jan 2017"), y: 33000 },
					{ x: new Date("1 Feb 2017"), y: 35960 },
					{ x: new Date("1 Mar 2017"), y: 42160 },
					{ x: new Date("1 Apr 2017"), y: 42240 },
					{ x: new Date("1 May 2017"), y: 43200 },
					{ x: new Date("1 Jun 2017"), y: 40600 },
					{ x: new Date("1 Jul 2017"), y: 42560 },
					{ x: new Date("1 Aug 2017"), y: 44280 },
					{ x: new Date("1 Sep 2017"), y: 44800 },
					{ x: new Date("1 Oct 2017"), y: 48720 },
					{ x: new Date("1 Nov 2017"), y: 50840 },
					{ x: new Date("1 Dec 2017"), y: 51600 }
				]
			}
		],
		"Returning Visitors": [
			{
				...
				type: "column",
				dataPoints: [
					{ x: new Date("1 Jan 2017"), y: 22000 },
					{ x: new Date("1 Feb 2017"), y: 26040 },
					{ x: new Date("1 Mar 2017"), y: 25840 },
					{ x: new Date("1 Apr 2017"), y: 23760 },
					{ x: new Date("1 May 2017"), y: 28800 },
					{ x: new Date("1 Jun 2017"), y: 29400 },
					{ x: new Date("1 Jul 2017"), y: 33440 },
					{ x: new Date("1 Aug 2017"), y: 37720 },
					{ x: new Date("1 Sep 2017"), y: 35200 },
					{ x: new Date("1 Oct 2017"), y: 35280 },
					{ x: new Date("1 Nov 2017"), y: 31160 },
					{ x: new Date("1 Dec 2017"), y: 34400 }
				]
			}
		]
	};
	
	// CanvasJS spline area chart to show revenue from Jan 2017 - Dec 2017
		...
		data: [
			{
				...
				yValueFormatString: "$###,###.##",
				dataPoints: [
					{ x: new Date("1 Jan 2017"), y: 100 },
					{ x: new Date("1 Feb 2017"), y: 200 },
					{ x: new Date("1 Mar 2017"), y: 400 },
					{ x: new Date("1 Apr 2017"), y: 200 },
					{ x: new Date("1 May 2017"), y: 500 },
					{ x: new Date("1 Jun 2017"), y: 900 },
					{ x: new Date("1 Jul 2017"), y: 700 },
					{ x: new Date("1 Aug 2017"), y: 900 },
					{ x: new Date("1 Sep 2017"), y: 800 },
					{ x: new Date("1 Oct 2017"), y: 1000 },
					{ x: new Date("1 Nov 2017"), y: 150 },
					{ x: new Date("1 Dec 2017"), y: 700 }
				]
			}
		]
	});
	...
	// CanvasJS spline chart to show users from Jan 2017 - Dec 2017
		...
		data: [
			{
				...
				type: "spline",
				dataPoints: [
					{ x: new Date("1 Jan 2017"), y: 55000 },
					{ x: new Date("1 Feb 2017"), y: 62000 },
					{ x: new Date("1 Mar 2017"), y: 68000 },
					{ x: new Date("1 Apr 2017"), y: 66000 },
					{ x: new Date("1 May 2017"), y: 72000 },
					{ x: new Date("1 Jun 2017"), y: 70000 },
					{ x: new Date("1 Jul 2017"), y: 76000 },
					{ x: new Date("1 Aug 2017"), y: 82000 },
					{ x: new Date("1 Sep 2017"), y: 80000 },
					{ x: new Date("1 Oct 2017"), y: 84000 },
					{ x: new Date("1 Nov 2017"), y: 82000 },
					{ x: new Date("1 Dec 2017"), y: 86000 }
				]
			}
		]
	});
